...
<body border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" bgcolor="#F7F7F7" style="margin: 0;">
    <table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" bgcolor="#F7F7F7" role="presentation">
        <tr>
                                ...
                                <tr class="">
                                    <td class="grid__col"
                                        ...
                                        <p style="color: #666666; font-weight: 400; font-size: 15px; line-height: 21px; font-family: 'Helvetica neue', Helvetica, arial, sans-serif; "
                                            class="">Please click on the button to complete the
                                                    ...
                                                    <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                                        <tr>
                                                            <td
                                                                ...
                                                                <a href="http://localhost:8000/{{ $email_data['guard'] === 'user' ? 'user' : 'admin' }}/verify?code={{ $email_data['verifyToken'] }}"
                                                                    target="_blank"
                                                                    style="display:inline-block; color: #fff; font-weight: 400; border-left: 15px solid; border-right: 15px solid; border-top: 12px solid; border-bottom: 12px solid; font-size: 17px; text-decoration: none; text-align: center; -webkit-text-size-adjust: none; -webkit-border-radius: 3px; -moz-border-radius: 3px; border-radius: 3px; font-family: 'Helvetica neue', Helvetica, arial, sans-serif; background-color: #e8716d; border-color: #e8716d;"
                                                                    class="btn"> <span
                                        ...
                                        <p style="color: #666666; font-weight: 400; font-size: 15px; line-height: 21px; font-family: 'Helvetica neue', Helvetica, arial, sans-serif; "
                                            class="">If you didn&#39;t attempt to verify your email
                                            address with Obagz-Stores, please delete this email.</p>
